...
import { saveRequestDemoData } from "@/utils/apiRequest";
...
const DemoModalContent = ({handleClick}: Props) => {
    ...
    <div className="grid grid-cols-2 gap-10 px-10">
      <div className="col-span-1">
        <div className="flex flex-col gap-5">
          <Typography
            text="Get started with your personalised demo"
          ...
          <div className="flex gap-2">
            <Typography classes="font-light text-xl text-lightText" text="+" />
            <Typography
              classes="font-light text-lightText"
              text="Turpis amet sed ut eget sociis dolor"
            />
          </div>
          <div className="flex gap-2">
            <Typography classes="font-light text-xl text-lightText" text="+" />
            <Typography
              classes="font-light text-lightText"
              text="Cras arcu quisque imperdiet"
            />
          </div>
          <div className="flex gap-2">
            <Typography classes="font-light text-xl text-lightText" text="+" />
            <Typography
              classes="font-light text-lightText"
              text="Sapien mauris laoreet duis massa"
            />
          </div>
          <div className="flex gap-2">
            <Typography classes="font-light text-xl text-lightText" text="+" />
      ...
      <div className="col-span-1">
        <Formik
          ...
          onSubmit={async(values, { setSubmitting }) => {
            ...
            try {
              const response = await saveRequestDemoData({ ...rest, phone: { std, phone_number } });
