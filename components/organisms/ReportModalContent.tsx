...
import ReportModalImage from "../../public/images/Frame.svg";
import { Form, Formik } from "formik";
import { validationSchema } from "@/utils/validationSchema";
import { saveDownloadReportData } from "@/utils/apiRequest";
...
const ReportModalContent = ({handleClick}: Props) => {
    ...
    <div className="grid grid-cols-2 gap-10 px-10">
      <div className="col-span-1">
        <div className="flex flex-col gap-5">
          <Typography
            text="Assessment Trends Report 2024 Corporate Edition"
          ...
          />
          <Image src={ReportModalImage} alt="Brochure Image" className="w-full"/>
          <Typography
            classes="font-light"
      ...
      <div className="col-span-1">
        <Formik
          ...
          onSubmit={async(values, { setSubmitting }) => {
            ...
            try {
              const response = await saveDownloadReportData({ ...rest, phone: { std, phone_number } });
